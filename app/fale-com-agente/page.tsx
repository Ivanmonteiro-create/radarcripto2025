...
export default function FaleComAGentePage() {
  ...
  const waHref = useMemo(() => {
    ...
    return waReady ? `${base}${WA_ENV}?text=${txt}` : undefined;
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setSubmitting(true);
    await new Promise((r) => setTimeout(r, 900)); // simulação de envio
    setSubmitting(false);
    setSent(true);
    ...
    <main className="contact-page">
      ...
      <section className="grid">
        ...
        <form className={`card form ${sent ? "form--sent" : ""}`} onSubmit={onSubmit}>
          ...
          <div className="actions">
            ...
            <a
              className={`rc-btn rc-btn--whatsapp ${waReady ? "" : "is-disabled"}`}
              href={waHref}
        ...
        <aside className="card faq">
          ...
          <details className="qa">
            ...
            <p>
              Sim. Clique em <strong>Chamar no WhatsApp</strong> ao lado do botão de envio do formulário.
            </p>
          </details>
      ...
      <style jsx>{`
        ...
        .grid {
          width: var(--w);
          display: grid;
          grid-template-columns: 1.25fr 0.75fr; /* Form maior */
          gap: var(--gap);
          align-items: start;
        }
        ...
        .form .fieldrow { margin-bottom: 12px; }
        .form .fieldrow.two {
          display: grid;
          gap: 12px;
        ...
        .sent-badge .dot {
          width: 10px; height: 10px; border-radius: 999px; background: #18e273;
        ...
        .faq .qa p { margin: 8px 0 0; opacity: 0.9; }
        ...
        .rc-btn--whatsapp {
          background: #25d366; color: #052515;
          box-shadow: 0 0 18px rgba(37,211,102,.8), inset 0 0 10px rgba(37,211,102,.5);
        }
        .rc-btn--whatsapp:hover {
          filter: brightness(1.2); transform: translateY(-2px);
          box-shadow: 0 0 28px rgba(37,211,102,1), inset 0 0 16px rgba(37,211,102,.7);
        }
        .rc-btn--whatsapp.is-disabled { opacity: .55; cursor: not-allowed; pointer-events: none; }
        .wa-ico { display: inline-flex; margin-right: 8px; }
