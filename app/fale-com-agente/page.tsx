...
const WA_ENV = process.env.NEXT_PUBLIC_WHATSAPP || ""; // ex.: 351912345678
  ...
  return (
    <main className="contact-page">
      ...
      <section className="grid">
        ...
        <form className={`card form ${sent ? "form--sent" : ""}`} onSubmit={onSubmit}>
          ...
          <div className="actions">
            ...
            {/* WhatsApp — agora com o mesmo brilho fluorescente */}
            <a
              className={`rc-btn rc-btn--green rc-btn--waalive ${waReady ? "" : "is-disabled"}`}
              href={waHref}
      ...
      <style jsx>{`
        ...
        /* Botão WhatsApp agora com mesmo brilho */
        .rc-btn--waalive {
          box-shadow: 0 0 18px rgba(24, 226, 115, 0.8), inset 0 0 10px rgba(24, 226, 115, 0.5);
        }
        .rc-btn--waalive:hover {
          filter: brightness(1.35);
          transform: translateY(-2px);
          box-shadow: 0 0 28px rgba(24, 226, 115, 1), inset 0 0 16px rgba(24, 226, 115, 0.7);
        }

        .rc-btn--waalive.is-disabled {
          opacity: 0.55;
          cursor: not-allowed;
          pointer-events: none;
        }
